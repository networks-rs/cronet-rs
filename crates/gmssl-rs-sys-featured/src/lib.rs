...
extern "C" {
    ...
    // Streaming CBC
    pub fn sm4_cbc_encrypt_init(ctx: *mut SM4_CBC_CTX, key: *const u8, iv: *const u8) -> c_int;
    ...
    pub fn sm4_cbc_decrypt_init(ctx: *mut SM4_CBC_CTX, key: *const u8, iv: *const u8) -> c_int;
    ...
    // Streaming CTR
    pub fn sm4_ctr_encrypt_init(ctx: *mut SM4_CTR_CTX, key: *const u8, ctr: *const u8) -> c_int;
...
extern "C" {
    ...
    pub fn sm2_public_key_to_der(
        key: *const SM2_KEY,
        out: *mut *mut u8,
        outlen: *mut size_t,
    ) -> c_int;
    pub fn sm2_public_key_from_der(
        key: *mut SM2_KEY,
        in_: *mut *const u8,
        inlen: *mut size_t,
    ) -> c_int;
    pub fn sm2_private_key_to_der(
        key: *const SM2_KEY,
        out: *mut *mut u8,
        outlen: *mut size_t,
    ) -> c_int;
    pub fn sm2_private_key_from_der(
        key: *mut SM2_KEY,
        in_: *mut *const u8,
        inlen: *mut size_t,
    ) -> c_int;
    ...
    pub fn sm2_public_key_info_to_der(
        key: *const SM2_KEY,
        out: *mut *mut u8,
        outlen: *mut size_t,
    ) -> c_int;
    pub fn sm2_public_key_info_from_der(
        key: *mut SM2_KEY,
        in_: *mut *const u8,
        inlen: *mut size_t,
    ) -> c_int;
    ...
    pub fn sm2_private_key_info_to_der(
        key: *const SM2_KEY,
        out: *mut *mut u8,
        outlen: *mut size_t,
    ) -> c_int;
    ...
    // ECDH
    pub fn sm2_do_ecdh(key: *const SM2_KEY, peer_key: *const SM2_KEY, out: *mut u8) -> c_int;
    pub fn sm2_ecdh(key: *const SM2_KEY, uncompressed_point: *const u8, out: *mut u8) -> c_int;
}
...
extern "C" {
    ...
    pub fn sm9_enc_master_public_key_to_pem(mpk: *const SM9_ENC_MASTER_KEY, fp: *mut FILE)
        -> c_int;
    pub fn sm9_enc_master_public_key_from_pem(mpk: *mut SM9_ENC_MASTER_KEY, fp: *mut FILE)
        -> c_int;
...
extern "C" {
    ...
    pub fn x509_public_key_info_to_der(
        key: *const X509_KEY,
        out: *mut *mut u8,
        outlen: *mut size_t,
    ) -> c_int;
    pub fn x509_public_key_info_from_der(
        key: *mut X509_KEY,
        in_: *mut *const u8,
        inlen: *mut size_t,
    ) -> c_int;
...
extern "C" {
    ...
    pub fn x509_cert_get_signature_algor(a: *const u8, alen: size_t, oid: *mut c_int) -> c_int;
...
extern "C" {
    ...
    pub fn zuc_mac_finish(ctx: *mut ZUC_MAC_CTX, data: *const u8, nbits: size_t, mac: *mut u8);
    ...
    pub fn zuc256_mac_init(ctx: *mut ZUC256_MAC_CTX, key: *const u8, iv: *const u8, macbits: c_int);

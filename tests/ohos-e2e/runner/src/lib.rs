...
async fn run_all() {
    posts_streams_and_enforces_the_response_limit().await;
    dropping_a_stream_cancels_it_and_async_shutdown_completes().await;
    bidirectional_stream_failure_is_async_and_shutdown_safe().await;
}

#[allow(clippy::too_many_lines)]
async fn posts_streams_and_enforces_the_response_limit() {
